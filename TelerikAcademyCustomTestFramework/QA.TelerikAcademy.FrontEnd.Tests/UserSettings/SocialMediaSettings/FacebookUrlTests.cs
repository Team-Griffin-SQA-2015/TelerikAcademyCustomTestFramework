namespace QA.TelerikAcademy.FrontEnd.Tests.UserSettings.SocialMediaSettings
{
    ...
    [TestClass]
    public class FacebookUrlTests : BaseTest
    {
        private readonly User currentUser;

        public FacebookUrlTests()
        {
        ...
        public void EnteringInvalidFacebookUrlWithLengthAboveUpperLimitShouldThrowErrorMessage()
        {
            this.currentUser.FacebookUrl = FacebookUrlConstants.InvalidFacebookUrlWithLengthAboveUpperLimit;
        ...
        [TestMethod, Owner(Owners.LyudmilNikodimov), Priority(Priorities.Medium), TestCategory(Modules.Settings)]
        public void EnteringInvalidFacebookUrlWithLengthUnderLowerLimitShouldThrowErrorMessage()
        {
            this.currentUser.FacebookUrl = FacebookUrlConstants.InvalidFacebookUrlWithLengthUnderLowerLimit;
            this.SettingsService.EditingSettings(this.currentUser);
            this.SettingsService.SettingsPage.Map.FieldValidationError.AssertIsPresent();
        }

        [TestMethod, Owner(Owners.LyudmilNikodimov), Priority(Priorities.Medium), TestCategory(Modules.Settings)]
        public void EnteringValidFacebookUrlShouldSuccessfullyUpdateUserSettings()
        {
            this.currentUser.FacebookUrl = FacebookUrlConstants.ValidFacebookUrl;
            ...
            this.currentUser.FacebookUrl = string.Empty;
